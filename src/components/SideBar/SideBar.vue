...
><!--  -->
    ...
    <div class="fixed top-0 left-0 z-19 w-64 h-full transition-all duration-500 transform -translate-x-full bg-white shadow-lg peer-checked:translate-x-0">
      <div class="px-6 py-4">
            ...
            <div class="flex-colums mt-5">
              <div class="relative">
                <input 
                  ...
                  :class="{loading: 'pl-10'}"
                  :placeholder="!loading ? 'Pesquisar Carro/Dono': ''"
                  v-model="searchQuery"
                />
                <div role="status" class="absolute left-1/2 top-1/2 transform -translate-y-1/2" v-if="loading">
